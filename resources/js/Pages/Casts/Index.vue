<template>
  <AdminLayout title="Dashboard">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Casts</h2>
    </template>
    <div>
          ...
          <div class="w-full overflow-x-auto">
            <Table>
              ...
              <TableRow v-for="cast in casts.data" :key="cast.id">
                ...
                <TableData class="font-semibold">{{ cast.slug }}</TableData>
                ...
                <TableData>
                  <div class="flex justify-around">
                    <ButtonLink
                      ...
                      :link="route('admin.casts.edit', cast.id)"
                    >
                      Edit
                    </ButtonLink>
                    <ButtonLink
